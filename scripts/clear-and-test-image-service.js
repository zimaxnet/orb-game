...
async function clearAndTestImageService() {
    console.log('🧹 Clearing old image data and testing new service...\n');
    ...
    try {
        ...
        console.log('🧹 Clearing old image data...');
        const clearResult = await imageService.collection.deleteMany({});
        console.log(`✅ Cleared ${clearResult.deletedCount} old image records\n`);
        ...
        if (archimedesImages.length > 0) {
            ...
            console.log(`   Source: ${archimedesImages[0].source}`);
        }
        console.log('');
        ...
        if (einsteinImages.length > 0) {
            ...
            console.log(`   Source: ${einsteinImages[0].source}`);
        }
        console.log('');
        ...
        if (unknownImages.length > 0) {
            ...
            console.log(`   Source: ${unknownImages[0].source}`);
        }
        console.log('');
        ...
        console.log('✨ New image service is working correctly!');
