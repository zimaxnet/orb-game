...
export const PROMPT_REFERENCE_DATA = {
  ...
  frontendPrompts: {
    Technology: {
      Ancient: {
        'o4-mini': {
          en: 'Conduct a comprehensive analytical examination of how ancient civilizations would have approached a groundbreaking technological discovery. Use systematic logical reasoning to connect their worldview with the innovation. Provide detailed analysis of the technology\'s mechanism, cultural context, implementation challenges, and lasting impact. Include specific examples, empirical evidence, and clear cause-effect relationships. Generate a substantive 250-400 word analytical narrative with definitive conclusions and concrete insights. Never end with questions or suggestions.',
          es: 'Realiza un examen analítico comprensivo de cómo las civilizaciones antiguas habrían abordado un descubrimiento tecnológico revolucionario. Usa razonamiento lógico sistemático para conectar su cosmovisión con la innovación. Proporciona análisis detallado del mecanismo de la tecnología, contexto cultural, desafíos de implementación e impacto duradero. Incluye ejemplos específicos, evidencia empírica y relaciones claras de causa-efecto. Genera una narrativa analítica sustantiva de 250-400 palabras con conclusiones definitivas y percepciones concretas. Nunca termines con preguntas o sugerencias.'
        },
        'grok-4': {
