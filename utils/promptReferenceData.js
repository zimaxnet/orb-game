 ...
 * 
 * This file contains all prompts from PROMPTS_REFERENCE.md in a structured format
 * that can be used by the PromptManager. This serves as the single source of truth
 * for all prompts in the Orb Game system.
 */

export const PROMPT_REFERENCE_DATA = {
  // Frontend prompts organized by category, epoch, and language
  frontendPrompts: {
    Technology: {
      Ancient: {
    ...
    Sports: {
      Ancient: {
        en: 'Generate an exciting positive news story about ancient sports achievements, athletic innovations, or sporting events that would have inspired ancient civilizations. Make it engaging and inspiring.',
        es: 'Generate an exciting positive news story about ancient sports achievements, athletic innovations, or sporting events that would have inspired ancient civilizations. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Medieval: {
        en: 'Create a fascinating positive news story about medieval sports competitions, athletic achievements, or sporting traditions that would have been celebrated in medieval times. Make it captivating and uplifting.',
        es: 'Create a fascinating positive news story about medieval sports competitions, athletic achievements, or sporting traditions that would have been celebrated in medieval times. Make it captivating and uplifting. Generate all content in Spanish.'
      },
      Industrial: {
        en: 'Write an inspiring positive news story about industrial revolution era sports developments, athletic innovations, or sporting achievements that transformed recreation. Make it exciting and motivational.',
        es: 'Write an inspiring positive news story about industrial revolution era sports developments, athletic innovations, or sporting achievements that transformed recreation. Make it exciting and motivational. Generate all content in Spanish.'
      },
      Modern: {
        en: 'Generate a compelling positive news story about modern sports achievements, athletic breakthroughs, or sporting innovations that are inspiring people today. Make it engaging and inspiring.',
        es: 'Generate a compelling positive news story about modern sports achievements, athletic breakthroughs, or sporting innovations that are inspiring people today. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Future: {
        en: 'Create an exciting positive news story about futuristic sports possibilities, athletic innovations, or sporting technologies that could revolutionize sports. Make it visionary and inspiring.',
        es: 'Create an exciting positive news story about futuristic sports possibilities, athletic innovations, or sporting technologies that could revolutionize sports. Make it visionary and inspiring. Generate all content in Spanish.'
      }
    },
    Music: {
      Ancient: {
        en: 'Generate an exciting positive news story about ancient music innovations, musical discoveries, or cultural achievements that would have enchanted ancient civilizations. Make it engaging and inspiring.',
        es: 'Generate an exciting positive news story about ancient music innovations, musical discoveries, or cultural achievements that would have enchanted ancient civilizations. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Medieval: {
        en: 'Create a fascinating positive news story about medieval music developments, musical breakthroughs, or cultural traditions that would have been revolutionary in medieval times. Make it captivating and uplifting.',
        es: 'Create a fascinating positive news story about medieval music developments, musical breakthroughs, or cultural traditions that would have been revolutionary in medieval times. Make it captivating and uplifting. Generate all content in Spanish.'
      },
      Industrial: {
        en: 'Write an inspiring positive news story about industrial revolution era music innovations, musical advancements, or cultural developments that transformed entertainment. Make it exciting and motivational.',
        es: 'Write an inspiring positive news story about industrial revolution era music innovations, musical advancements, or cultural developments that transformed entertainment. Make it exciting and motivational. Generate all content in Spanish.'
      },
      Modern: {
        en: 'Generate a compelling positive news story about modern music innovations, musical breakthroughs, or cultural achievements that are enriching lives today. Make it engaging and inspiring.',
        es: 'Generate a compelling positive news story about modern music innovations, musical breakthroughs, or cultural achievements that are enriching lives today. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Future: {
        en: 'Create an exciting positive news story about futuristic music possibilities, musical innovations, or cultural technologies that could revolutionize music. Make it visionary and inspiring.',
        es: 'Create an exciting positive news story about futuristic music possibilities, musical innovations, or cultural technologies that could revolutionize music. Make it visionary and inspiring. Generate all content in Spanish.'
      }
    },
    Space: {
      Ancient: {
        en: 'Generate an exciting positive news story about ancient space observations, astronomical discoveries, or celestial phenomena that would have fascinated ancient civilizations. Make it engaging and inspiring.',
        es: 'Generate an exciting positive news story about ancient space observations, astronomical discoveries, or celestial phenomena that would have fascinated ancient civilizations. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Medieval: {
        en: 'Create a fascinating positive news story about medieval space discoveries, astronomical observations, or celestial events that would have been remarkable in medieval times. Make it captivating and uplifting.',
        es: 'Create a fascinating positive news story about medieval space discoveries, astronomical observations, or celestial events that would have been remarkable in medieval times. Make it captivating and uplifting. Generate all content in Spanish.'
      },
      Industrial: {
        en: 'Write an inspiring positive news story about industrial revolution era space discoveries, astronomical innovations, or celestial observations that transformed understanding. Make it exciting and motivational.',
        es: 'Write an inspiring positive news story about industrial revolution era space discoveries, astronomical innovations, or celestial observations that transformed understanding. Make it exciting and motivational. Generate all content in Spanish.'
      },
      Modern: {
        en: 'Generate a compelling positive news story about modern space discoveries, space exploration achievements, or astronomical breakthroughs that are expanding our cosmic knowledge. Make it engaging and inspiring.',
        es: 'Generate a compelling positive news story about modern space discoveries, space exploration achievements, or astronomical breakthroughs that are expanding our cosmic knowledge. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Future: {
        en: 'Create an exciting positive news story about futuristic space possibilities, space exploration innovations, or astronomical breakthroughs that could revolutionize our understanding of the universe. Make it visionary and inspiring.',
        es: 'Create an exciting positive news story about futuristic space possibilities, space exploration innovations, or astronomical breakthroughs that could revolutionize our understanding of the universe. Make it visionary and inspiring. Generate all content in Spanish.'
      }
    },
    Innovation: {
      Ancient: {
        en: 'Generate an exciting positive news story about ancient innovation breakthroughs, technological discoveries, or creative achievements that would have revolutionized ancient civilizations. Make it engaging and inspiring.',
        es: 'Generate an exciting positive news story about ancient innovation breakthroughs, technological discoveries, or creative achievements that would have revolutionized ancient civilizations. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Medieval: {
        en: 'Create a fascinating positive news story about medieval innovation developments, technological breakthroughs, or creative innovations that would have been groundbreaking in medieval times. Make it captivating and uplifting.',
        es: 'Create a fascinating positive news story about medieval innovation developments, technological breakthroughs, or creative innovations that would have been groundbreaking in medieval times. Make it captivating and uplifting. Generate all content in Spanish.'
      },
      Industrial: {
        en: 'Write an inspiring positive news story about industrial revolution era innovation innovations, technological advancements, or creative breakthroughs that transformed society. Make it exciting and motivational.',
        es: 'Write an inspiring positive news story about industrial revolution era innovation innovations, technological advancements, or creative breakthroughs that transformed society. Make it exciting and motivational. Generate all content in Spanish.'
      },
      Modern: {
        en: 'Generate a compelling positive news story about modern innovation innovations, technological breakthroughs, or creative achievements that are transforming the world today. Make it engaging and inspiring.',
        es: 'Generate a compelling positive news story about modern innovation innovations, technological breakthroughs, or creative achievements that are transforming the world today. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      Future: {
        en: 'Create an exciting positive news story about futuristic innovation possibilities, technological innovations, or creative breakthroughs that could revolutionize human civilization. Make it visionary and inspiring.',
        es: 'Create an exciting positive news story about futuristic innovation possibilities, technological innovations, or creative breakthroughs that could revolutionize human civilization. Make it visionary and inspiring. Generate all content in Spanish.'
      },
      'Enlightenment': {
        en: 'Generate an exciting positive news story about enlightenment era innovation breakthroughs, intellectual discoveries, or creative achievements that would have inspired intellectual growth. Make it engaging and inspiring.',
        es: 'Generate an exciting positive news story about enlightenment era innovation breakthroughs, intellectual discoveries, or creative achievements that would have inspired intellectual growth. Make it engaging and inspiring. Generate all content in Spanish.'
      },
      'Digital': {
        en: 'Create an exciting positive news story about digital era innovation breakthroughs, digital discoveries, or creative achievements that are transforming modern society. Make it engaging and inspiring.',
        es: 'Create an exciting positive news story about digital era innovation breakthroughs, digital discoveries, or creative achievements that are transforming modern society. Make it engaging and inspiring. Generate all content in Spanish.'
      }
    },
    Spirituality: {
      Ancient: {
  ...
  backendPrompts: {
    'azure-openai': {
      en: 'Generate {count} fascinating, positive {category} stories from {epoch.toLowerCase()} times. Each story should be engaging, informative, and highlight remarkable achievements or discoveries.',
      es: 'Generate {count} fascinating, positive {category} stories from {epoch.toLowerCase()} times. Each story should be engaging, informative, and highlight remarkable achievements or discoveries. Generate all content in Spanish.'
    },
    'grok-4': {
      en: 'Generate {count} fascinating, positive {category} stories from {epoch.toLowerCase()} times. Each story should be engaging, informative, and highlight remarkable achievements or discoveries.',
      es: 'Generate {count} fascinating, positive {category} stories from {epoch.toLowerCase()} times. Each story should be engaging, informative, and highlight remarkable achievements or discoveries. Generate all content in Spanish.'
  ...
  // System prompts for chat endpoint
  systemPrompts: {
    en: 'You are Orb Game, a friendly and helpful AI assistant. You can help with questions, tell jokes, and provide information. Be engaging, positive, and conversational.',
    es: 'Eres Orb Game, un asistente de IA amigable y útil. Puedes ayudar con preguntas, contar chistes y proporcionar información. Sé atractivo, positivo y conversacional.'
  },

  // Web search prompts
  webSearchPrompts: {
    en: 'Search the web for current information about: {message}. Provide a helpful, accurate response based on the latest information available.',
    es: 'Search the web for current information about: {message}. Provide a helpful, accurate response based on the latest information available. Respond in Spanish.'
  },
  ...
  fallbackStories: {
    en: {
      ...
      summary: 'Great things are happening in {category} that inspire hope and progress.',
      fullText: 'The field of {category} continues to show remarkable progress and positive developments. These advances demonstrate the incredible potential for positive change and innovation in our world.',
      source: 'AI Generated'
    },
    es: {
      headline: 'Noticias Positivas de {category}',
      summary: 'Cosas increíbles están sucediendo en {category} que inspiran esperanza y progreso.',
      fullText: 'El campo de {category} continúa mostrando un progreso notable y desarrollos positivos. Estos avances demuestran el increíble potencial para el cambio positivo y la innovación en nuestro mundo.',
      source: 'IA Generado'
    }
  },
  ...
  // JSON response format for all models
  jsonResponseFormat: {
    'azure-openai': 'Return ONLY a valid JSON array with this exact format: [{ "headline": "Brief headline", "summary": "One sentence summary", "fullText": "2-3 sentence story", "source": "O4-Mini" }]',
    'grok-4': 'Return ONLY a valid JSON array with this exact format: [{ "headline": "Brief headline", "summary": "One sentence summary", "fullText": "2-3 sentence story", "source": "Grok 4" }]',
    'perplexity-sonar': 'Return ONLY a valid JSON array with this exact format: [{ "headline": "Brief headline", "summary": "One sentence summary", "fullText": "2-3 sentence story", "source": "Perplexity Sonar" }]',
    'gemini-1.5-flash': 'Return ONLY a valid JSON array with this exact format: [{ "headline": "Brief headline", "summary": "One sentence summary", "fullText": "2-3 sentence story", "source": "Gemini 1.5 Flash" }]'
  }
}; 